...
\icmltitlerunning{Where's the Plan? Pinpointing Latent Planning in Language Models}

\begin{document}

\twocolumn[
  \icmltitle{Where's the Plan? Pinpointing Latent Planning in Language Models}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Top-1 probe accuracy on rhyming couplets. Mirrors top-5 and rhyme accuracy results.}
...
\begin{figure}[H]
    ...
    \caption{Corrupt rhyme rate for true activation patching versus zero-vector and donor-prompt controls.}
