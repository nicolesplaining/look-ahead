...
\begin{figure*}[t]
    ...
    \begin{subfigure}{0.325\linewidth}
        ...
        \includegraphics[width=\linewidth]{media/results-probe/llama-top5.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \caption{Per-layer activation patching, Llama-3 1B--70B.}
