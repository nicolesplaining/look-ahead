...
SUPPORTED_MODELS = {
    ...
    "Qwen/Qwen3-32B":    "qwen3_32b",          # already done (N=20)
    # Gemma-3 family
    "google/gemma-3-1b-it":  "gemma3_1b",
    "google/gemma-3-4b-it":  "gemma3_4b",
    "google/gemma-3-12b-it": "gemma3_12b",
    "google/gemma-3-27b-it": "gemma3_27b",     # already done (N=20)
    # Llama family
    "meta-llama/Llama-3.3-70B-Instruct": "llama3.3_70b_instruct",
    "meta-llama/Llama-3.2-1B":           "llama3.2_1b",
    "meta-llama/Llama-3.2-3B":           "llama3.2_3b",
    "meta-llama/Llama-3.1-8B":           "llama3.1_8b",
...
def sample_completions(model, tokenizer, adapter: ModelAdapter,
                       prompt: str, n: int, temperature: float) -> list:
    return [
        generate_text(model, tokenizer, adapter, prompt, temperature)
...
def run_pair(model, tokenizer, adapter: ModelAdapter,
             model_name: str, pair: dict, results_dir: str) -> dict:
