"""
Replication of qwen2.5_32b_exp1 on Qwen3-32B.

Patch direction: corrupt → clean
  - Corrupt prompt: "...urge to sleep,\nBut then he"
  - Clean prompt:   "...urge to rest,\nBut then he"
...
EXPERIMENTS = [
    {"experiment_id": "exp1_newline", "selector": {"kind": "newline"}},
    {"experiment_id": "exp1_but",     "selector": {"kind": "token_text", "token_text": "But"}},
    {"experiment_id": "exp1_then",    "selector": {"kind": "token_text", "token_text": " then"}},
    {"experiment_id": "exp1_he",      "selector": {"kind": "token_text", "token_text": " he"}},
]
