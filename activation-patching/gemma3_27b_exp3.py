"""
Activation patching on Gemma-3-27B-IT — positions i=-1 and i=-2 relative to newline.

Patch direction: corrupt → clean
  i=-1: token ','    (comma before newline)
  i=-2: token ' fear' (the rhyme word itself)
"""
...
RESULTS_SUBDIR = "GEMMA3_PER_LAYER"
